...
import sckdn.lisa.model.CustomFileNameCell;
import sckdn.lisa.model.IllustsBean;
import sckdn.lisa.utils.Common;

import static sckdn.lisa.utils.Settings.FILE_PATH_SINGLE;
...
public class FileCreator {
    ...
    public static String customFileName(IllustsBean illustsBean, int index) {
        ...
        if (TextUtils.isEmpty(Lisa.sSettings.getFileNameJson())) {
            result = defaultFileCells();
        } else {
            result = new ArrayList<>(Lisa.sGson.fromJson(Lisa.sSettings.getFileNameJson(),
