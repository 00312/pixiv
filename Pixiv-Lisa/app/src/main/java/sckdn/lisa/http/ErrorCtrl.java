...
import sckdn.lisa.core.TryCatchObserver;
import sckdn.lisa.model.Error500;
import sckdn.lisa.model.Error500Obj;
import sckdn.lisa.model.ErrorResponse;
import sckdn.lisa.model.ErrorResponse2;
                ...
                if (!TextUtils.isEmpty(responseString) &&
                    ...
                    if (responseString.contains("validation_errors") || httpException.code() == 500) {
                        if (responseString.contains("body\":{")) {
                            Error500Obj response = Lisa.sGson.fromJson(responseString, Error500Obj.class);
                            ...
                            Error500 response = Lisa.sGson.fromJson(responseString, Error500.class);
                            if (response != null) {
                        ...
                        ErrorResponse2 response = Lisa.sGson.fromJson(responseString, ErrorResponse2.class);
                        if (response != null) {
                        ...
                        ErrorResponse response = Lisa.sGson.fromJson(responseString, ErrorResponse.class);
                        if (response != null) {
