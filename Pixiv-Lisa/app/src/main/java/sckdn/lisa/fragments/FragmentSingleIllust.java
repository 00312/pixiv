...
import sckdn.lisa.adapters.IllustDetailAdapter;
import sckdn.lisa.databinding.FragmentSingleIllustBinding;
...
import sckdn.lisa.view.ScrollChange;
...
public class FragmentSingleIllust extends BaseFragment<FragmentSingleIllustBinding> {
    ...
    public void vertical() {
        ...
        headParams.height = Lisa.statusHeight + Lisa.toolbarHeight;
    ...
    public void horizon() {
        //横屏
        ViewGroup.LayoutParams headParams = baseBind.head.getLayoutParams();
        headParams.height = Lisa.statusHeight * 3 / 5 + Lisa.toolbarHeight;
        baseBind.head.setLayoutParams(headParams);
    }
}
