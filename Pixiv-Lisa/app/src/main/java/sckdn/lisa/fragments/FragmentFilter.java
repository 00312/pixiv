...
import sckdn.lisa.databinding.FragmentFilterBinding;
...
public class FragmentFilter extends BaseFragment<FragmentFilterBinding> {
    ...
    public void initView() {
        ...
        for (int i = 0; i < PixivSearchParamUtil.ALL_SIZE_VALUE.length; i++) {
            if (PixivSearchParamUtil.ALL_SIZE_VALUE[i].equals(Lisa.sSettings.getSearchFilter())) {
        ...
        if (Lisa.sUserModel.getUser().isIs_premium()) {
