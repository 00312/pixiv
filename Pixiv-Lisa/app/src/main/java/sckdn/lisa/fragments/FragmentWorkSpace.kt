...
import sckdn.lisa.databinding.FragmentWorkSpaceBinding
...
class FragmentWorkSpace : SwipeFragment<FragmentWorkSpaceBinding>(), Display<UserDetailResponse> {
    ...
    public override fun initData() {
        Retro.getAppApi()
            .getUserDetail(Lisa.sUserModel.access_token, Lisa.sUserModel.userId)
...
//            comment=其他问题
            ...
            Retro.getAppApi().editWorkSpace(Lisa.sUserModel.access_token, map)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
