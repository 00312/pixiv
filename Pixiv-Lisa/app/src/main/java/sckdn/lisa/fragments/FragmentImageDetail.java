...
import sckdn.lisa.core.GlideApp;
import sckdn.lisa.databinding.FragmentImageDetailBinding;
...
public class FragmentImageDetail extends BaseFragment<FragmentImageDetailBinding> {
    ...
    private void loadImage() {
        ...
        if (Lisa.getMMKV().decodeBool(originUrl)) {
            imageUrl = originUrl;
        } else {
            if (!TextUtils.isEmpty(url)) {
                imageUrl = url;
            } else {
                if (Lisa.sSettings.isShowOriginalImage()) {
