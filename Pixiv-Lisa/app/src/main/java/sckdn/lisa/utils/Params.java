...
public class Params {
    ...
    public static final String FILTER_ILLUST        = "sckdn.lisa.fragments.NetListFragment FILTER_ILLUST";
    public static final String LIKED_ILLUST        = "sckdn.lisa.fragments.NetListFragment LIKED_ILLUST";
    public static final String PLAY_GIF        = "sckdn.lisa.fragments.FragmentSingleUgora PLAY_GIF";
    public static final String LIKED_USER          = "sckdn.lisa.fragments.NetListFragment LIKED_USER";
    public static final String LIKED_NOVEL         = "sckdn.lisa.fragments.NetListFragment LIKED_NOVEL";
    public static final String DOWNLOAD_FINISH         = "sckdn.lisa.fragments.NetListFragment DOWNLOAD_FINISH";
    public static final String DOWNLOAD_ING         = "sckdn.lisa.fragments.NetListFragment DOWNLOAD_ING";
    public static final String REFRESH_MAIN_ACTIVITY         = "sckdn.lisa.REFRESH_MAIN_ACTIVITY";
    public static final String FRAGMENT_ADD_DATA         = "sckdn.lisa.FRAGMENT_ADD_DATA";
    public static final String FRAGMENT_ADD_RELATED_DATA         = "sckdn.lisa.FRAGMENT_ADD_RELATED_DATA";
